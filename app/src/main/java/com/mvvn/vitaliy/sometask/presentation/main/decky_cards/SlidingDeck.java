...
public class SlidingDeck extends ViewGroup {
    ...
    private final static int MAXIMUM_ITEMS_ON_SCREEN = 8;
    private int ITEMS_TOP_MARGIN_DP = 15;
    ...
    public int getItemsMarginTop() {
        return itemsMarginTop;
    }

    public void setItemsMarginTop(int itemsMarginTop) {
        this.itemsMarginTop = itemsMarginTop;
    }
    ...
    public SlidingDeck(Context context, int marginTop, int maxView) {
        super(context);
        initializeViewWithoutAttr(maxView, marginTop);
    }
    ...
    private void initializeViewWithoutAttr(int maxCount, int overlay) {
        maximumViewsOnScreen =maxCount;
        itemsMarginTop =overlay;
        viewsBuffer = new View[maximumViewsOnScreen];
        touchController = new SlidingDeckTouchController(this);
    }
